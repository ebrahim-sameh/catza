  ...
  return (
    ...
    >
      ...
      <path
        fill="#EA4335"
        fillRule="evenodd"
        d="M12.5 5.074c1.688 0 3.204.58 4.396 1.72l3.298-3.299C18.203 1.64 15.6.5 12.5.5A11.496 11.496 0 002.223 6.835l3.842 2.98c.904-2.718 3.44-4.741 6.435-4.741z"
        clipRule="evenodd"
      ></path>
    </svg>
  );
